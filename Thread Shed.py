...
for i in daily_transactions:
  i = i.split("_")
  daily_transaction_split.append(i)

#print(daily_transaction_split)

transactions_clean = []

for i in daily_transaction_split:
  transaction = []
  for n in i:
    transaction.append(n.replace("\n", "").strip(" "))
...
for color in colors:
  print("{count} threads of {c} were sold today".format(count = color_count(color), c = color))
